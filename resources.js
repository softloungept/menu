class Resources {
  ...
  static _strings = {
    ...
    en: {
      ...
      "(arroz, batata frita, feijão preto, farófia)": "(rice, french fries, black beans, farófia)",
      ...
      "OMELETES": "OMELETTE",
      "(Acompanhamento: batata frita, tomate)": "(Side dish: french fries and tomato)",
      ...
      "½ Torrada c/ Doce ou Mel": "½ Toasted bread with jam or honey",
      "Polvo à galega": "Galician octopus",
      "Amêijoa à bulhão pato": "'Bulhão pato' clams",
      "Ovos mexidos com alheira": "Scrambled eggs with alheira",
      "Tábua mista": "Mixed board",
      "SALADAS": "SALADS",
      "(frango, molho caesar, alface, tomate cherry, queijo parmesão)": "(chicken, caesar sauce, lettuce, cherry tomato, parmesan cheese)",
      "Búfala": "Buffalo",
      "(mozzarella de búfala, tomate)": "(buffalo mozzarella, tomato)",
      "Bife à portuguesa": "Portuguese steak",
      "(batata frita à rodela, ovo estrelado)": "(potato chips, fried egg)",
      "Bife 3 pimentas": "3 pepper steak",
      "(com esparregado e batata frita)": "(with creamed spinach and french fries)",
      "Secretos em cama de puré de beterraba": "'Secretos' on a bed of beet puree",
      "Supremo de frango em cama de puré de batata doce": "Chicken supreme on a bed of sweet potato puree",
      "PEIXE": "FISH",
      "Polvo à lagareiro": "'Lagareiro' octopus",
      "(com batata a murro)": "(with mashed potatoes)",
      "Bacalhau confitado": "Confit codfish",
      "(com puré de batata doce e legumes da época)": "(with mashed sweet potatoes and seasonal vegetables)",
      "Lombo de Salmão com batata noisette e legumes aromatizados": "Salmon loin with noisette potatoes and flavored vegetables",
      "Paccheri com gambas": "Prawn paccheri",
      "Vogali com amêijoas": "Vogali with clams",
      "(camarão e lulas)": "(shrimp and squid)",
      "Camarão e limão com manjericão": "Shrimp and lemon with basil",
      "Cogumelos": "Mushrooms",
